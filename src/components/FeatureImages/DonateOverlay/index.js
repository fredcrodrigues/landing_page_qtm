...
function DonateOverlay(props) {
  const donations = ["Dashboard Personalizado", " Gestão simples e transparente ","Relatórios Personalizados"];
  return (
    <VStack
      w="263px"
      bg="white"
    ...
    >
      {donations.map((donation) => (
        ...
        >
        {/*<Text>Controle de ganhos</Text>*/}
          <Text align={"center"}>{donation}</Text>
        </HStack>
      ))}
    </VStack>
  );
